...
window.onload = function() {
    ...
    game.preload('static/files/cenario.png',
                 'static/files/personagem.png',
                 'static/files/rock.png',
                 'static/files/Hit.mp3',
                 'static/files/bgm.mp3');
    game.fps = 30;
    game.scale = 2.0;
...
var SceneGame = Class.create(Scene, {
    ...
    initialize: function() {
        ...
        var game, label, bg, personagem, iceGroup;
        ...
        bg.image = game.assets['static/files/cenario.png'];

        personagem = new Personagem();
        personagem.x = game.width/2 - personagem.width/2;
        personagem.y = 360;
        ...
        this.bgm = game.assets['static/files/bgm.mp3']; // Add this line
    ...
    handleTouchControl: function (evt) {
        ...
        this.personagem.switchToLaneNumber(lane);
    },
    ...
    update: function(evt) {
        ...
        for (var i = this.iceGroup.childNodes.length - 1; i >= 0; i--) {
            ...
            if(ice.intersect(this.personagem)){
                var game;
                game = Game.instance;
                game.assets['static/files/Hit.mp3'].play();
 ...
 * Personagem
 */
 var Personagem = Class.create(Sprite, {
    /**
    ...
    initialize: function() {
        ...
        this.image = Game.instance.assets['static/files/personagem.png'];
...
var Ice = Class.create(Sprite, {
    /**
     * The obstacle that the personagem must avoid
     */
    initialize: function(lane) {
        // Call superclass constructor
        Sprite.apply(this,[36, 48]);
        this.image  = Game.instance.assets['static/files/rock.png'];
